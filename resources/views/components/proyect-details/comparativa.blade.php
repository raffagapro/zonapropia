              ...
              <div class="col-12 mb-4">
                <div class="row align-items-center">
                  ...
                  <div class="col-12 col-md-3">
                    @if (count($tipo->tipologias)>0)
                      <img src="{{ Storage::url($tipo->tipologias[0]->media) }}" class="cl-floor-img"> 
                    @endif
                  </div>
                  <!-- Info -->
                    ...
                    <div class="row">
                      ...
                      <div class="col-12">
                        ...
                        <div class="row text-center cl-info-cont-lg">
                          ...
                          <div class="col-lg-2">
                            @if ((int)$tipo->superficie_terrazas === 0 || $tipo->unidad->superficie_terrazas === null)
                              <h5>No</h5>
                            @else
                              <h5>Si</h5>
                            @endif
