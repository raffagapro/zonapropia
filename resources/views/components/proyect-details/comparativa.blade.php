    ...
    <div class="card mb-section-card mt-0">
      <div class="card-body row mt-5 mb-5">
        ...
        <div class="col-12 mt-5">
          <div class="row">
            @forelse ($proyect->unidades as $uni)
              <!-- Item List -->
              <div class="col-12 mb-4">
                <div class="row align-items-center">
                  <!-- Floor plan -->
                  <div class="col-12 col-md-3">
                    <img src="{{ asset($uni->tipologia) }}" class="cl-floor-img">
                  </div>
                  <!-- Info -->
                    ...
                    <div class="row">
                      ...
                      <div class="col-12">
                        ...
                        <div class="row text-center cl-info-cont-lg">
                          ...
                          <!-- Info -->
                          <div class="col-lg-2"><h5>{{ $uni->superficie_total }}m<sup>2</sup></h5></div>
                          <div class="col-lg-2"><h5>UF {{ $uni->uf_m2 }}</h5></div>
                          <div class="col-lg-2"><h5>UF {{ $uni->precio_venta }}</h5></div>
                          <div class="col-lg-2">
                            @if ((int)$uni->superficie_terrazas === 0 || $uni->superficie_terrazas === null)
                              <h5>No</h5>
                            @else
                              <h5>Si</h5>
                            @endif
                          </div>
                          <div class="col-lg-2"><h5>{{ $uni->banos }}</h5></div>
                          <div class="col-lg-2"><h5>{{ $uni->dormitorios }}</h5></div>
                        </div>
                        <!-- Info for Tablet & Mobile version -->
                        <div class="row text-right cl-info-cont">
                          <!-- row -->
                          <div class="col-6"><small>m<sup>2</sup> Promedio</small></div>
                          <div class="col-6 text-center"><h5>{{ $uni->superficie_total }}m<sup>2</sup></h5></div>
                          <!-- row -->
                          <div class="col-6"><small>UF m<sup>2</sup> Promedio</small></div>
                          <div class="col-6 text-center"><h5>UF {{ $uni->uf_m2 }}</h5></div>
                          <!-- row -->
                          <div class="col-6"><small>Precio Promedio</small></div>
                          <div class="col-6 text-center"><h5>UF {{ $uni->precio_venta }}</h5></div>
                          <!-- row -->
                          ...
                          <div class="col-6 text-center"><h5>{{ $uni->banos }}</h5></div>
                          <!-- row -->
                          <div class="col-6"><small>Nº Dormitorios</small></div>
                          <div class="col-6 text-center"><h5>{{ $uni->dormitorios }}</h5></div>
                        </div>
                      </div>
                    </div>
                  </div>
